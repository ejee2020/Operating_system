...
struct dir
  {
    ...
    struct lock dir_lock;               /* Lock for data synchronization */
...
/* Returns the inode of the parent working directory. */
struct inode*
get_parent_inode (struct dir* dir) {
  if(dir == NULL) return NULL;

  struct dir_entry e;
  if(inode_read_at(dir->inode, &e, sizeof e, 0) == sizeof e)
...
dir_create (block_sector_t sector, size_t entry_cnt)
{
  ...
  bool success = inode_write_at(dir->inode, &e, sizeof e, 0) == sizeof e;
